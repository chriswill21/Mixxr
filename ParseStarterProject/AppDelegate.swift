...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        let parseConfiguration = ParseClientConfiguration(block: { (ParseMutableClientConfiguration) -> Void in
            ParseMutableClientConfiguration.applicationId = "9378c8477cb58ad993bc370471ab8573ee9eef5e"
            ParseMutableClientConfiguration.clientKey = "1611ac06ab3205a9894f67942ae697155eeb1ddf"
            ParseMutableClientConfiguration.server = "http://ec2-34-223-211-184.us-west-2.compute.amazonaws.com:80/parse"
        })
